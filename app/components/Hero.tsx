...
<span className="flex gap-2 items-center">Full Stack Developer <pre className="text-blue-400 font-bold">&lt;/&gt;</pre></span>        </div>
...
<h1 className="text-4xl sm:text-6xl lg:text-7xl font-semibold tracking-tight text-white leading-[1.15] sm:leading-[1.1]">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 pt-2">
          <Link href={"/#projects"} className="group flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl bg-white text-black font-medium text-sm hover:bg-gray-100 transition-all duration-200 shadow-lg shadow-white/5 active:scale-95">
            <span>View Projects</span>
            <span className="group-hover:translate-x-1 transition-transform duration-200"><ArrowUpRightFromCircle/></span>
          </Link>
          
          <a href="/cv.pdf" className="flex items-center gap-5 justify-center px-6 py-3.5 rounded-xl bg-white/5 hover:bg-white/10 text-white font-medium text-sm border border-white/10 backdrop-blur-md transition-all duration-200 active:scale-95">
