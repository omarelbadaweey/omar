...
const GlowCursor = ({
  ...
  useEffect(() => {
    ...
    let pointerInside = true; // نضمن إن الحركة متفعلة فوراً
    let fade = 1;
    ...
    // القراءة المباشرة من الشاشة بدون تعقيدات الـ Bounding Rect
    const updatePointer = (event: MouseEvent | PointerEvent) => {
      const x = event.clientX;
      const y = height - event.clientY; // تعكيس اتجاه Y ليتوافق مع WebGL Context
